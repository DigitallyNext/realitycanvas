...
export const SparkleButton = ({ text = "Generate thumbnails", className, ...props }: SparkleButtonProps) => {
    ...
    return (
        <button
            className={cn("group relative my-8 rounded-full bg-gradient-to-r from-blue-300/30 via-blue-500/30 via-40% to-purple-500/30 p-1 text-white transition-transform hover:scale-110 active:scale-105", className)}
